...
export default function Cards() {
  ...
  return (
    <div className="mt-20 max-w-[120rem] mx-auto md:mt-0 px-5 lg:px-16 gap-7 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 mb-14 lg:mb-0">
            <div className="flex flex-col backdrop-blur-xl px-5 border py-20 md:gap-0 rounded-xl justify-center items-center">
            <div className='mb-2 bg-c-yellow  backdrop-blur-xl p-3 translate-y-2 rounded-full mt-4 stroke-none '>
        ...
        <div className="flex flex-col backdrop-blur-xl px-5 border py-10 md:gap-0 rounded-xl justify-center items-center">
            <div className='mb-2 bg-c-yellow backdrop-blur-xl p-3 rounded-full mt-4 stroke-none '>
        ...
        <div className="flex flex-col backdrop-blur-xl px-5 border py-10 md:gap-0 rounded-xl justify-center items-center">
                <div className='mb-2 bg-c-yellow backdrop-blur-xl p-3 rounded-full mt-4 stroke-none -translate-y-3'>
